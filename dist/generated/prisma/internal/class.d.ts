 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.aiReview`: Exposes CRUD operations for the **AiReview** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more AiReviews
      * const aiReviews = await prisma.aiReview.findMany()
      * ```
      */
    get aiReview(): Prisma.AiReviewDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.aIissue`: Exposes CRUD operations for the **AIissue** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more AIissues
      * const aIissues = await prisma.aIissue.findMany()
      * ```
      */
    get aIissue(): Prisma.AIissueDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
